 ...
 * @author aluno
 */
public class frmPerdendo extends javax.swing.JFrame {
    ...
    public frmPerdendo(String nome){
        this();
       
        
        lblNome.setText("Infezlimente Você perdeu "+nome+ " :(");
    ...
    private void initComponents() {
        ...
        lblNome.setFont(new java.awt.Font("Eras Bold ITC", 1, 24)); // NOI18N
        lblNome.setForeground(new java.awt.Color(51, 51, 255));
        lblNome.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblNome.setText("Infezlimente você perdeu :(");

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/gif/gifPerdedor (1).gif"))); // NOI18N
        jLabel2.setMinimumSize(new java.awt.Dimension(450, 390));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmPerdendo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmPerdendo().setVisible(true);
            }
        });
    }
